...
describe AchievementsController do
  ...
  describe 'authenticated user' do
    ...
    describe 'GET new' do
      ...
      it 'assigns new Achievement ot @achievement' do
        get :new
    ...
    describe 'POST create' do
      ...
      context 'invalid data' do
        ...
        it 'doesnt create achievement in database' do
          expect {
            post :create, params: { achievement: invalid_data }
    ...
    context 'is the owner of the achievement' do
      ...
      describe 'PUT update' do
        ...
        context 'invalid data' do
          let(:invalid_data) { FactoryBot.attributes_for(:public_achievement, title: '', descripiton: 'new')}
